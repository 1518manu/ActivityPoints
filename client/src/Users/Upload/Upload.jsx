...
export function CertificateUploadPage() {
  ...
  const activityOptions = {
    ...
    "Entrepreneurship and Innovation": ["Foreign Language Skill (TOEFL/ IELTS/ BEC exams etc.)","Startup Company-Registered legally ", "Patent Filed ",
      "Patent - Published","Patent- Approved ","Patent- Licensed",
       "Product Development","Awards for Products developed ","Innovative technologies developed and used by industries/users ",
  ...
  const handleSubmit = () => {
    if (!certificateName || !selectedFile || !activityHead || !activity || (isLevelRequired() && !achievementLevel) || (isRoleRequired() && !role)) {
